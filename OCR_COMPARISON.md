...
| 模型 | 准确率 | 速度 | 中文支持 | Markdown输出 | GPU需求 | 推荐度 |
|------|--------|------|----------|--------------|---------|--------|
| MiniCPM-o | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ✅ | 高 | ⭐⭐⭐⭐ |
| dots.ocr | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ✅ | 中 | ⭐⭐⭐⭐⭐ |
| Marker+Surya | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ✅ | 低-中 | ⭐⭐⭐⭐⭐ |
...
## 💡 为什么本项目选择 Marker + Surya?

### 主要原因:

1. **专为PDF→Markdown设计**
   - 这正是你的需求 (PPT→PDF→Markdown)
